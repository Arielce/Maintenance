...
public class ProgressView extends View {
     ...
     * 选中和没选中的颜色
     */
    private int checkedColor = UIUtils.getColor(R.color.md_teal_500);
    private int uncheckedColor = UIUtils.getColor(R.color.md_grey_500);
    ...
    private void initValues() {
        circleRadius = UIUtils.dip2px(CIRCLE_RADIUS);
        stokenRadius = UIUtils.dip2px(STOKEN_RADIUS);
        stokenWidth = UIUtils.dip2px(STOKEN_WIDTH);
        linePadding = UIUtils.dip2px(LINE_PADDING);
        textPaddingTop = UIUtils.dip2px(TEXTPADDINGTOP);
        normaltextSize = UIUtils.sp2px(NORMALTEXTSIZE);
    }
