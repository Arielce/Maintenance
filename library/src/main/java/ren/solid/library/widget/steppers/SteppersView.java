...
public class SteppersView extends LinearLayout {
    ...
    public static class Config {
        ...
        private OnResultClickAction onResultClickAction;
        ...
        public Config setOnResultClickAction(OnResultClickAction onResultClickAction) {
            this.onResultClickAction = onResultClickAction;
            return this;
        }

        public OnResultClickAction getOnResultClickAction() {
            return onResultClickAction;
        }
